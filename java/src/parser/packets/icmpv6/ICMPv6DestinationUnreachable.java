...
public class ICMPv6DestinationUnreachable extends ICMPv6 {
  byte[] unused; //32
  ...
  public ICMPv6DestinationUnreachable () {
    this.noob = 1;
  }
  ...
  public static ICMPv6DestinationUnreachable parse (byte[] data) throws IndexOutOfBoundsException, NullPointerException {
    ICMPv6DestinationUnreachable icmPv6 = new ICMPv6DestinationUnreachable();
    ...
    icmPv6.setiPv6Packet(IPv6Packet.parse(ipv6));
    return icmPv6;
  }
}
